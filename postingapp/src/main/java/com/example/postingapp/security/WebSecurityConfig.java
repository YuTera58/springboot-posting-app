...
public class WebSecurityConfig {
    ...
    //passwordEncoder()メソッドでは、BCryptPasswordEncoderクラスのインスタンスを返すことで、パスワードのハッシュアルゴリズム（ハッシュ化のルール）を「BCrypt」に設定しています。
    //なお、BCryptはパスワード用のハッシュ値を生成してくれる強力なハッシュアルゴリズムです。
    @Bean
